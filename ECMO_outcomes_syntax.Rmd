...
#drop missings
match_nomiss <- ecmo_final8 %>% select(trt, mort, age, GSCHL, bmi, rea, unshockable, lac_closest_within48h_after_ecmo, ph_closest_within48h_after_ecmo) %>%
  na.omit()
match_nomiss$trt <- as.factor(match_nomiss$trt)

mod_match <- matchit(trt ~ age + GSCHL + bmi + rea + unshockable + lac_closest_within48h_after_ecmo + ph_closest_within48h_after_ecmo,
...
trt + age_q4 + sex_chart + bmi_q4 + rea + unshockable + lac_q4 + ph_q4
