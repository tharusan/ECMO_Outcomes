...
2.2 check cases with "unclear" ECMO
2.3 check "unclear" and missing Impella
...
ecmo_master3_test <- ecmo_master3 %>% filter(rosc_num == 0 &  (rea == "In-hospital" | rea == "Out-of-hospital") & ecmo == "VA-ECMO") #check all patients with unclear or missing rea

xtabs(~campus+ecmo,data=ecmo_master3_test)

t.test(mort + ecmella_final, data = ecmo_master3_test)

log_mort <- glm(mort ~ ecmella_final,
