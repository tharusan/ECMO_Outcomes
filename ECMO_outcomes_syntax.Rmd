...
##Lactate
  ...
  lacb4_c <- lacb4_c %>% dplyr::rename(lacb4_c ="N2VALUE")
  ...
  lacb4_h <- lacb4_h %>% dplyr::rename(lacb4_h ="N2VALUE")
...
crea <- lab4 %>% filter(N2KATTEXT %in% c("Kreatinin (Jaffé)", "Kreatinin (Jaffé) HP"))
  ...
  creab4_c <- creab4_c %>% dplyr::rename(creab4_c ="N2VALUE")
  ...
  creal8_c <- creal8_c %>% dplyr::rename(creal8_c ="N2VALUE")
...
trop <- lab4 %>% filter(N2KATTEXT %in% c("Troponin-Ths", "Troponin-Ths HP", "Troponin T hs"))
  ...
  tropb4_c <- tropb4_c %>% dplyr::rename(tropb4_c ="N2VALUE")
  ...
  tropb4_h <- tropb4_h %>% dplyr::rename(tropb4_h ="N2VALUE")
  ...
  tropl8_c <- tropl8_c %>% dplyr::rename(tropl8_c ="N2VALUE")
  
  #highest
  tropl8_h <-tropl8[order(tropl8$id, -tropl8$N2VALUE),]
  tropl8_h <- tropl8_h %>% distinct(id, .keep_all = T)
  
  tropl8_h <- tropl8_h %>% dplyr::rename(tropl8_h ="N2VALUE")
...
ck <- lab4 %>% filter(N2KATTEXT %in% c("CK", "Creatinkinase (CK)", "Creatinkinase (CK) HP"))
 ...
 #first selecting only values before (b4) implantation of Ecmo, meaning time_to_lab needs to be negative 
  ...
  ckb4_c <- ckb4_c %>% dplyr::rename(ckb4_c ="N2VALUE")
  ...
  ckb4_h <- ckb4_h %>% dplyr::rename(ckb4_h ="N2VALUE")
...
ckmb <- lab4 %>% filter(N2KATTEXT %in% c("CK-MB", "CK-MB HP"))
  ...
  ckmbb4_c <- ckmbb4_c %>% distinct(id, .keep_all = T)
    ...
    ckmbb4_c <- ckmbb4_c %>% dplyr::rename(ckmbb4_c ="N2VALUE")
  ...
  ckmbb4_h <- ckmbb4_h %>% distinct(id, .keep_all = T)
    ...
    ckmbb4_h <- ckmbb4_h %>% dplyr::rename(ckmbb4_h ="N2VALUE")
...
#pH
  ...
  phb4_c <- phb4_c %>% distinct(id, .keep_all = T)
   ...
   phb4_c <- phb4_c %>% dplyr::rename(phb4_c ="N2VALUE")
  ...
  phb4_l <- phb4_l %>% distinct(id, .keep_all = T)
    ...
    phb4_l <- phb4_l %>% dplyr::rename(phb4_l ="N2VALUE")
...
sapsc5.2 <- merge(sapsc5, ecmo_master8[,c(1,2,9)], by.x="FALLNR", by.y="Fallnumer", all=F)
  ...
  sapsc5_b4_c <- sapsc5_b4_c %>% distinct(id, .keep_all = T)
    ...
    sapsc5_b4_c <- rename(sapsc5_b4_c, sapsc5_b4_c = Gesamtscore)
  ...
  sapsc5_l8_c <- rename(sapsc5_l8_c, sapsc5_l8_c = Gesamtscore)
...
#tiss10  -copra 6
  ...
  tiss10c6b4_c <- rename(tiss10c6b4_c, tiss10b4_c = val)
  ...
  tiss10c6l8_c <- rename(tiss10c6l8_c, tiss10l8_c = val)
...
#tiss28 -copra 5 
 ...
 #copra 5 
  ...
  tiss28b4_c <- rename(tiss28b4_c, tiss28b4_c = Gesamtscore)
  ...
  tiss28l8_c <- rename(tiss28l8_c, tiss28l8_c = Gesamtscore)
...
hfl8_c$hfl8_c <- ifelse(is.na(hfl8_c$vFloat), hfl8_c$val, 
...
hfb4_c$hfb4_c <- ifelse(is.na(hfb4_c$vFloat), hfb4_c$val, 
...
afc5b4_c <- rename(afc5b4_c, afb4_c = vFloat)
...
afc5l8_c <- rename(afc5l8_c, afl8_c = vFloat)
...
psab4_c <- rename(psab4_c, psab4_c = vFloat)
...
psal8_c <- rename(psal8_c, psal8_c = vFloat)
...
pdab4_c <- rename(pdab4_c, pdab4_c = vFloat)
...
pdal8_c <- rename(pdal8_c, pdal8_c = vFloat)
...
pmab4_c <- rename(pmab4_c, pmab4_c = vFloat)
...
pmal8_c <- rename(pmal8_c, pmal8_c = vFloat)
...
ecmo_master10 <- Reduce(
  ...
  list(ecmo_master8, id_bmi_sex_lab2[,c(1,4,5,14)], phl8_c[,c(6,11)], phl8_l[,c(6,11)], lacl8_c[,c(6,11)], lacl8_h[,c(6,11)], ckl8_c[,c(6,11)], ckl8_h[,c(6,11)], ckmbl8_c[,c(6,11)], ckmbl8_h[,c(6,11)],  phb4_c[,c(6,11)], phb4_l[,c(6,11)], lacb4_c[,c(6,11)], lacb4_h[,c(6,11)], ckb4_c[,c(6,11)], ckb4_h[,c(6,11)], ckmbb4_c[,c(6,11)], ckmbb4_h[,c(6,11)], tropb4_c[,c(6,11)], tropb4_h[,c(6,11)], tropl8_c[,c(6,11)], tropl8_h[,c(6,11)], creab4_c[,c(6,11)], creal8_c[,c(6,11)], hfb4_c[,c(1,6)], hfl8_c[,c(1,6)], apacheb4, apachel8, gcsb4, gcsl8, sapsc5_b4_c[,c(3,6)], tiss10c6b4_c[,c(4,6)], tiss10c6l8_c[,c(4,6)], afc5b4_c[,c(3,5)], afc5l8_c[,c(3,5)], psab4_c[,c(3,5)], psal8_c[,c(3,5)], pdab4_c[,c(3,5)], pdal8_c[,c(3,5)], pmab4_c[,c(3,5)], pmal8_c[,c(3,5)]  )
)


#clean up 

ecmo_master11 <- ecmo_master10 %>% select(id, Fallnumer, Patientenummer, GBDAT, age, age_q4, GSCHL, height_chart, weight_chart, bmi, admission2, discharge, length_of_stay2, ICU_admission2, ICU_discharge2, ICU_length_of_stay2, `Sterbezeit (0 = nicht tot)`, mort, campus2, year, ecmo, ecmo_num, ecmo_implantation, `ECMO wann eingebaut?`, ecmo_ex, ecmo_interval, ecmo_time2, impella, impella_num, impella_implantation, `Impella wann eingebaut?`,  impella_ex, impella_interval, impella_time2, ppci,  impella_during_ecmo, ecmo_during_impella,  ecmella_true, ecmella_final, ecmella_num, intervention, trt, rosc_num, rea, shockable, unshockable, stemi, nstemi, mi, cs, lae, pul, intox, sepsis, aortdiss, hi, myocarditis, cad, diag1, diag2, diag3, diag4, diag5, infarct, prov1_t1, prov2_t1, prov3_t1, prov1_t2, prov2_t2, prov3_t3, prov1, prov1_num, prov1_fact, ef1, ef2, phb4_c, phb4_l, phl8_c, phl8_l, lacb4_c, lacb4_h, lacl8_c, lacl8_h, ckb4_c, ckb4_h, ckl8_c, ckl8_h, ckmbb4_c, ckmbb4_h, ckmbl8_c, ckmbl8_h, tropb4_c, tropb4_h, tropl8_c, tropl8_h, creab4_c, creal8_c, hfb4_c, hfl8_c, afb4_c, afl8_c, psab4_c, psal8_c, pdab4_c, pdal8_c, pmab4_c, pmal8_c, apacheb4, apachel8, gcsb4, gcsl8, sapsc5_b4_c, tiss10b4_c, tiss10l8_c) 
