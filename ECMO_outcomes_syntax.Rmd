...
match_nomiss <- ecmo_final8 %>% select(id, trt, mort, age, GSCHL, bmi, rea, unshockable, lac_closest_within48h_after_ecmo, ph_closest_within48h_after_ecmo, survdays, SAVE, iabp)

match_nomiss <- match_nomiss %>% select(trt, mort, age, GSCHL, bmi, rea, unshockable, lac_closest_within48h_after_ecmo, survdays, SAVE, iabp) %>% na.omit()
...
#Perform matching
mod_match <- matchit(trt ~ age + GSCHL + bmi + rea + unshockable + lac_closest_within48h_after_ecmo + SAVE + iabp,
...
surviver_all$nyha <- recode(surviver_all$`Atemnot schwere Belastung`, "1"="4", "2"="3", "3"="2", "4"="1") 
...
surviver_graph4 <- ggarrange(dizzy, sweat, tired, fit, alltag_eingesch, job_eingesch, ncol=1, nrow=6 )
