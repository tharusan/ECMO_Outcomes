...
#new tables
ecmo_master7_table1 <-  table1(~ campus2 + rea + mort + length_of_stay2 + ICU_length_of_stay2 + ecmo_time2|intervention, data= ecmo_master7)

ecmo_master7_table2 <-  table1(~ cad + shockable +unshockable + ef1 + ef2|intervention, data= ecmo_master7)
