...
ecmo_master3 <- ecmo_master3 %>% mutate(trt = case_when(ecmella_final == TRUE   ~ 1,
...
ecmo_master3_test <- ecmo_master3 %>% filter(rosc_num == 0 &  (rea == "In-hospital" | rea == "Out-of-hospital") & (trt == 1 | trt == 0)) #check all patients with unclear or missing rea

xtabs(~campus+trt,data=ecmo_master3_test)
